...
enum OBJID { OBJ_MAIN_UI, OBJ_STAGE_UI, OBJ_LIFE_UI, OBJ_EFFECT, OBJ_PLAYER,OBJ_GAMEOVER_UI,
						 OBJ_BULLET, 
...
enum CHANNELID { SOUND_BGM, SOUND_FIRE ,SOUND_EFFECT, SOUND_DEAD, SOUND_HIT,MAXCHANNEL };
